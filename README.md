...
- **Category pages**
  - There should be a separate page for each of the various product categories (e.g. "Home", "Kitchen", "Bed & Bath", "Home Office", etc...)
  - These pages should show various (at least 4 per category) products with images, names, and prices. 
